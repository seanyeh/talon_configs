...
git push everything: "git add . && GIT_EDITOR='nvim +startinsert' git commit && git push\n"
git push interactive: "git add . -p && GIT_EDITOR='nvim +startinsert' git commit && git push\n"
git rebase master: "git rebase origin/master"
git rebase interactive: "git rebase -i master"
